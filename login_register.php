 <?php
	...
	if (isset($_POST['register'])) {
		$uid = $_POST['userid'];
		$upass = hash('sha512',$_POST['userpass']);
		$upass1 = hash('sha512',$_POST['userpass1']);
	...
	if (isset($_POST['login'])) {
		...
		if($uid=="AUTAR001" && $upass=="aaaaa001"  ){
			session_start();
					$_SESSION['UserFullName'] = "Admin";
					$_SESSION['UserID'] = "AUTAR001";
...
<body background="image\wadde.jpg" >
	<!--Login form-->
	...
	<form method="POST" class="registerform" action="login_register.php">
		...
		<br><br>
		<input type="password" name="userpass" placeholder="Password" minlength="8" maxlength="12" required>
		<br><br>
